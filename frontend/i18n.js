(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      '種類：フォトフォルダ、クエストフォルダ': 'Types: Photo folders and Quest folders',
      '5. フォトフォルダ': '5. Photo folders',
      'まず任意の写真をアップロードします。アップロードされた写真に対して、チームメンバーでコメントを残すことができます。':
        'First, upload any photos you choose. Team members can leave comments on the uploaded photos.',
      '6. クエストフォルダ': '6. Quest folders',
      'まず撮影して欲しい写真を依頼します。依頼された写真をチームメンバーがアップロードします。アップロードされた写真に対して、チームメンバーでコメントを残すことができます。':
        'First, request the photos you want taken. Team members upload the requested photos, and the team can leave comments on the uploaded photos.',
      '5. 写真': '5. Photos',
      '7. 写真': '7. Photos',
      ...
      '10. 権限管理': '10. Permission management',
      '全閲覧 / 自分のみ': 'Everyone / self only',
      '9. 料金プラン': '9. Pricing plans',
      '11. 料金プラン': '11. Pricing plans',
    ...
    'zh-CN': {
      ...
      'フリー：2つ': '免费：2 个',
      '有料：無制限': '付费：无限制',
      '種類：フォトフォルダ、クエストフォルダ': '类型：照片文件夹、任务文件夹',
      '5. フォトフォルダ': '5. 照片文件夹',
      'まず任意の写真をアップロードします。アップロードされた写真に対して、チームメンバーでコメントを残すことができます。':
        '首先上传任意照片。团队成员可以对已上传的照片发表评论。',
      '6. クエストフォルダ': '6. 任务文件夹',
      'まず撮影して欲しい写真を依頼します。依頼された写真をチームメンバーがアップロードします。アップロードされた写真に対して、チームメンバーでコメントを残すことができます。':
        '首先提出希望拍摄的照片请求。团队成员上传被请求的照片后，团队成员可以对已上传的照片发表评论。',
      '5. 写真': '5. 照片',
      '7. 写真': '7. 照片',
    ...
    vi: {
     ...
     '大きな準備なしで導入できる。':
      ...
      '種類：フォトフォルダ、クエストフォルダ': 'Loại: thư mục ảnh, thư mục nhiệm vụ',
      '5. フォトフォルダ': '5. Thư mục ảnh',
      'まず任意の写真をアップロードします。アップロードされた写真に対して、チームメンバーでコメントを残すことができます。':
        'Trước tiên, tải lên ảnh tùy ý. Thành viên trong nhóm có thể để lại bình luận cho các ảnh đã tải lên.',
      '6. クエストフォルダ': '6. Thư mục nhiệm vụ',
      'まず撮影して欲しい写真を依頼します。依頼された写真をチームメンバーがアップロードします。アップロードされた写真に対して、チームメンバーでコメントを残すことができます。':
        'Trước tiên, yêu cầu ảnh cần chụp. Thành viên trong nhóm tải lên ảnh được yêu cầu, sau đó nhóm có thể để lại bình luận cho các ảnh đã tải lên.',
      '5. 写真': '5. Ảnh',
      '7. 写真': '7. Ảnh',
  ...
  const CONG_TRANSLATIONS = {
    en: {
      'Cong | Container Log': 'Cong | Container Log',
      'Cong | Container Log デモ': 'Cong | Container Log Demo',
      'Cong - Container Log | 港湾・物流向けコンテナ写真記録サービス':
        'Cong - Container Log | Container Photo Logging for Port and Logistics Teams',
      'Cong Container Log ユーザーマニュアル': 'Cong Container Log User Manual',
      Cong: 'Cong',
      ...
      コンテナ登録: 'Register container',
      コンテナパスワード: 'Container password',
      'コンテナパスワード（任意）': 'Container password (optional)',
      'コンテナパスワード（空で解除）': 'Container password (blank to clear)',
      対象コンテナ: 'Target container',
      '現在のコンテナに設定します。空で保存すると解除されます。':
        'Set this for the current container. Save blank to clear it.',
      'コンテナ番号を選択してください': 'Select a container number',
      'コンテナ番号を入力してください。': 'Enter a container number.',
      記録: 'Record',
      検索: 'Search',
      タグ: 'Tag',
      検索語: 'Search term',
      このコンテナ: 'This container',
      このお部屋: 'This room',
      保存済み写真の検索: 'Search saved photos',
      検索範囲: 'Search scope',
      '保存済み写真をタグ・検索語・範囲で探します。': 'Search saved photos by tag, keyword, and scope.',
      'コンテナ・コメント・投稿者': 'Container, comment, or uploader',
      記録モード: 'Record mode',
      ...
      新しい順: 'Newest first',
      古い順: 'Oldest first',
      '撮ってきてほしい写真を入力': 'Enter the photos you need captured',
      'Congはコンテナ写真の記録・共有・管理をシンプルにするサービスです。':
        'Cong simplifies recording, sharing, and managing container photos.',
      '現場で撮影した写真をコンテナ番号ごとに整理し、送信・仕分け・確認業務を減らします。':
        'It organizes field photos by container number and reduces sending, sorting, and checking work.',
      特徴: 'Features',
      コンテナ番号単位で管理: 'Manage by container number',
      タグによる分類: 'Classify with tags',
      写真とコメントを一元管理: 'Manage photos and comments in one place',
      クエストによる撮影漏れ防止: 'Prevent missed shots with quests',
      PowerPoint出力: 'PowerPoint export',
      権限管理: 'Permission management',
      '3. お部屋': '3. Rooms',
      'お部屋は企業・事業所単位で利用します。': 'Rooms are used by company or site.',
      '1ユーザー1部屋': 'One room per user',
      URL招待: 'URL invitation',
      '7日間有効': 'Valid for 7 days',
      '4. フォルダ': '4. Folders',
      'フォルダはコンテナ単位で利用します。': 'Folders are used for each container.',
      'コンテナ番号をフォルダ名として利用できます。': 'Use the container number as the folder name.',
      例: 'Example',
      '将来的にはOCRによる自動入力にも対応予定です。':
        'OCR-based automatic input is planned for the future.',
      '5. フォトフォルダ': '5. Photo folders',
      'フォトフォルダでは写真を記録します。': 'Photo folders are used to record photos.',
      '写真にはタグを付与できます。': 'You can assign tags to photos.',
      推奨タグ: 'Recommended tags',
      '写真ごとにコメントを残せます。': 'You can leave comments on each photo.',
      '6. クエストフォルダ': '6. Quest folders',
      'クエストフォルダは撮影依頼に利用します。': 'Quest folders are used for photo capture requests.',
      '□ コンテナ番号': '□ Container number',
      '□ シール': '□ Seal',
      '□ 左側面': '□ Left side',
      '□ 右側面': '□ Right side',
      '□ 損傷箇所': '□ Damaged area',
      '必要な写真を事前に依頼できます。': 'You can request required photos in advance.',
      '撮影漏れ防止に利用します。': 'Use this to prevent missed shots.',
      '7. 写真': '7. Photos',
      '写真は単体または一括アップロード可能です。': 'Photos can be uploaded one by one or in bulk.',
      '撮影後にタグ付けできます。': 'Tags can be added after shooting.',
      '8. コメント': '8. Comments',
      シール破損あり: 'Seal is damaged',
      左側面にへこみあり: 'Dent on the left side',
      搬出完了: 'Gate-out completed',
      '9. 出力': '9. Export',
      'フォルダ単位でPowerPoint出力できます。': 'PowerPoint can be exported by folder.',
      'コンテナ報告資料作成に利用できます。': 'Use this to create container report materials.',
      '10. 権限管理': '10. Permission management',
      管理者: 'Admin',
      メンバー: 'Member',
      お部屋管理: 'Room management',
      フォルダ管理: 'Folder management',
      メンバー管理: 'Member management',
      写真登録: 'Photo registration',
      ...
      '先にコンテナを選択してください。': 'Select a container first.',
      '同じ写真は同じコンテナにアップロードできません（重複を検知しました）。':
        'The same photo cannot be uploaded to the same container. A duplicate was detected.',
      '条件に合う写真はなかです。': 'No photos match the conditions.',
      'まだコンテナがなかです': 'No containers yet.',
      'コンテナを選択してください': 'Select a container',
      コンテナ招待: 'Container invitation',
      コンテナ招待URL: 'Container invitation URL',
      自分のコンテナのみ: 'My containers only',
      全コンテナ表示: 'Show all containers',
      全コンテナ: 'All containers',
      コンテナメンバー: 'Container members',
      'このコンテナは鍵付きです。パスワードを入力してください。':
        'This container is locked. Enter the password.',
      'コンテナパスワードが必要です。': 'Container password is required.',
      'コンテナパスワードが違います。': 'Container password is incorrect.',
      'コンテナの鍵を更新しました。': 'Container lock was updated.',
      'コンテナを削除しました。': 'Container was deleted.',
      'フリープランではコンテナは2つまでです。有料プランで無制限になります。':
        'The Free plan allows up to 2 containers. Paid plans allow unlimited containers.',
      '1GB〜10GBプラン: コンテナ無制限 / 3年保存 / PPT透かしなし':
        '1GB-10GB plans: unlimited containers / 3-year storage / no PPT watermark',
      'フリープラン: コンテナ2個 / 30日保存 / PPT透かしあり':
        'Free plan: 2 containers / 30-day storage / PPT watermark',
      '・コンテナの数が2つ以下': '- Container count must be 2 or less',
      '・現在のコンテナ数: {count}': '- Current container count: {count}',
      'コンテナ {count} / 無制限': 'Containers {count} / unlimited',
      'コンテナ {count} / {limit}': 'Containers {count} / {limit}',
      'フリープランへ戻すには、容量512MB未満・コンテナ2個以下である必要があります。':
        'To return to the Free plan, storage must be under 512 MB and container count must be 2 or less.',
      '現在の上限は、容量512MB未満・コンテナ2個までです。':
        'Current limits are under 512 MB and up to 2 containers.',
      'コンテナ：{title} を登録しました。': 'Registered container: {title}.',
      'コンテナ:': 'Container:',
      'コンテナの写真記録を、': 'Container photo logging,',
      'もっとシンプルに。': 'made simpler.',
      'コンテナ番号ごとに整理。': 'Organized by container number.',
      '撮影から共有まで、その場で完結。': 'From capture to sharing, completed on site.',
      '登録して無料で試す': 'Sign up and try for free',
      '登録なしで試す': 'Try without signing up',
      'コンテナ写真の送信・仕分け・確認業務を減らします。':
        'Reduce the work of sending, sorting, and checking container photos.',
      'コンテナ単位で管理': 'Manage by container',
      '写真をコンテナ番号ごとに整理': 'Organize photos by container number',
      'タグで整理': 'Organize with tags',
      '搬入・シール・損傷・搬出を記録': 'Record gate-in, seal, damage, and gate-out',
      'スマホで完結': 'Complete on a phone',
      '現場で撮ってそのまま保存': 'Shoot on site and save immediately',
      '現場ではこう動いている': 'How field work currently happens',
      'コンテナを撮影': 'Take container photos',
      'LINEやメールで送信': 'Send them by LINE or email',
      '事務所で整理': 'Sort them at the office',
      'その結果': 'As a result',
      '送信作業が発生': 'Sending work is created',
      '仕分け作業が発生': 'Sorting work is created',
      '写真を探す時間が発生': 'Time is spent searching for photos',
      '写真は残る。でも管理が大変。': 'Photos remain. Managing them is the hard part.',
      '撮影・送信・仕分け・確認が別々のため、': 'Because shooting, sending, sorting, and checking are separate,',
      '余計な業務が発生しています。': 'extra work is created.',
      '撮る': 'Shoot',
      '送る': 'Send',
      '探す': 'Find',
      'この分断によって、': 'This separation creates',
      '「写真を撮った後の仕事」': '"work after taking photos"',
      'が発生しています。': '.',
      '現場は忙しい。だから複雑な仕組みは使われない。':
        'Field teams are busy. Complex systems do not stick.',
      '入力を増やせない': 'Inputs cannot increase',
      '長い入力は現場で使われない': 'Long input forms are not used in the field',
      '教育できない': 'Training is hard',
      '誰でもすぐ使える必要がある': 'Anyone needs to use it right away',
      'PCを開かない': 'No PC required',
      'スマホ中心で完結したい': 'Work should be completed mainly on phones',
      'Congはコンテナ単位で写真を整理します。': 'Cong organizes photos by container.',
      'コンテナ番号ごとに管理': 'Manage by container number',
      'をタグで記録': 'are recorded with tags',
      '現場で写真を残す': 'Keep photos on site',
      'タグを選ぶ': 'Choose a tag',
      '搬入・シール・損傷・搬出': 'Gate-in, seal, damage, and gate-out',
      '保存': 'Save',
      'コンテナごとに整理': 'Organized by container',
      'Congが減らす3つの業務': 'Three types of work Cong reduces',
      '写真を撮る業務は変わりません。': 'Taking photos does not change.',
      'その後に発生する業務を減らします。': 'It reduces the work that happens afterward.',
      '送信業務を減らす': 'Reduce sending work',
      '現場で撮った写真を': 'Photos taken on site',
      'LINEやメールで送る手間を減らします。': 'no longer need to be sent by LINE or email.',
      '仕分け業務を減らす': 'Reduce sorting work',
      'コンテナ番号ごとに整理されるため、': 'Because photos are organized by container number,',
      '事務所での仕分け作業を減らします。': 'office sorting work is reduced.',
      '確認業務を減らす': 'Reduce checking work',
      '必要な写真が揃っているか、': 'Admins can quickly check',
      '管理者がすぐ確認できます。': 'whether required photos are complete.',
      '写真を撮った後の仕事が変わります。': 'The work after taking photos changes.',
      '撮る → 送る → 仕分ける': 'Shoot -> send -> sort',
      '現場は送信、': 'The field sends,',
      '事務所は仕分け。': 'the office sorts,',
      '写真の後処理が発生します。': 'and photo follow-up work is created.',
      '撮る → 保存完了': 'Shoot -> saved',
      '必要な写真がすぐ見つかります。': 'Required photos are found quickly.',
      'コンテナ写真の管理を、': 'Container photo management,',
      'まずは触って、': 'Try it first,',
      '今の運用との違いを体感してください。': 'and feel the difference from your current workflow.',
    },
    'zh-CN': {
      'Cong | Container Log': 'Cong | Container Log',
      'Cong | Container Log デモ': 'Cong | Container Log 演示',
      'Cong - Container Log | 港湾・物流向けコンテナ写真記録サービス':
        'Cong - Container Log | 面向港口和物流的集装箱照片记录服务',
      'Cong Container Log ユーザーマニュアル': 'Cong Container Log 用户手册',
      Cong: 'Cong',
      ...
      コンテナ登録: '登记集装箱',
      コンテナパスワード: '集装箱密码',
      'コンテナパスワード（任意）': '集装箱密码（可选）',
      'コンテナパスワード（空で解除）': '集装箱密码（留空则解除）',
      対象コンテナ: '目标集装箱',
      '現在のコンテナに設定します。空で保存すると解除されます。': '为当前集装箱设置。留空保存则解除。',
      'コンテナ番号を選択してください': '请选择集装箱编号',
      'コンテナ番号を入力してください。': '请输入集装箱编号。',
      記録: '记录',
      検索: '搜索',
      タグ: '标签',
      検索語: '搜索词',
      ...
      保存済み写真の検索: '搜索已保存照片',
      検索範囲: '搜索范围',
      '保存済み写真をタグ・検索語・範囲で探します。': '按标签、搜索词和范围查找已保存照片。',
      'コンテナ・コメント・投稿者': '集装箱、评论或上传者',
      記録モード: '记录模式',
      通常記録: '普通记录',
      クエスト記録: '任务记录',
      ...
      新しい順: '最新优先',
      古い順: '最旧优先',
      '撮ってきてほしい写真を入力': '输入需要拍摄的照片',
      'Congはコンテナ写真の記録・共有・管理をシンプルにするサービスです。':
        'Cong 是让集装箱照片的记录、共享和管理更简单的服务。',
      '現場で撮影した写真をコンテナ番号ごとに整理し、送信・仕分け・確認業務を減らします。':
        '按集装箱编号整理现场拍摄的照片，减少发送、分类和确认工作。',
      特徴: '特点',
      コンテナ番号単位で管理: '按集装箱编号管理',
      タグによる分類: '用标签分类',
      写真とコメントを一元管理: '集中管理照片和评论',
      クエストによる撮影漏れ防止: '通过任务防止漏拍',
      PowerPoint出力: 'PowerPoint 导出',
      権限管理: '权限管理',
      '3. お部屋': '3. 房间',
      'お部屋は企業・事業所単位で利用します。': '房间按企业或事业所单位使用。',
      '1ユーザー1部屋': '每个用户一个房间',
      URL招待: 'URL 邀请',
      '7日間有効': '有效期 7 天',
      '4. フォルダ': '4. 文件夹',
      'フォルダはコンテナ単位で利用します。': '文件夹按集装箱单位使用。',
      'コンテナ番号をフォルダ名として利用できます。': '可将集装箱编号作为文件夹名。',
      例: '示例',
      '将来的にはOCRによる自動入力にも対応予定です。': '未来计划支持 OCR 自动输入。',
      '5. フォトフォルダ': '5. 照片文件夹',
      'フォトフォルダでは写真を記録します。': '照片文件夹用于记录照片。',
      '写真にはタグを付与できます。': '可以给照片添加标签。',
      推奨タグ: '推荐标签',
      '写真ごとにコメントを残せます。': '可以为每张照片留下评论。',
      '6. クエストフォルダ': '6. 任务文件夹',
      'クエストフォルダは撮影依頼に利用します。': '任务文件夹用于拍摄请求。',
      '□ コンテナ番号': '□ 集装箱编号',
      '□ シール': '□ 封条',
      '□ 左側面': '□ 左侧面',
      '□ 右側面': '□ 右侧面',
      '□ 損傷箇所': '□ 损伤位置',
      '必要な写真を事前に依頼できます。': '可以预先请求所需照片。',
      '撮影漏れ防止に利用します。': '用于防止漏拍。',
      '7. 写真': '7. 照片',
      '写真は単体または一括アップロード可能です。': '照片可以单张或批量上传。',
      '撮影後にタグ付けできます。': '拍摄后可以添加标签。',
      '8. コメント': '8. 评论',
      シール破損あり: '封条有破损',
      左側面にへこみあり: '左侧面有凹陷',
      搬出完了: '出场完成',
      '9. 出力': '9. 导出',
      'フォルダ単位でPowerPoint出力できます。': '可按文件夹导出 PowerPoint。',
      'コンテナ報告資料作成に利用できます。': '可用于制作集装箱报告资料。',
      '10. 権限管理': '10. 权限管理',
      管理者: '管理员',
      メンバー: '成员',
      お部屋管理: '房间管理',
      ...
      不可: '不可',
      Congレポート: 'Cong 报告',
      '先にコンテナを選択してください。': '请先选择集装箱。',
      '同じ写真は同じコンテナにアップロードできません（重複を検知しました）。': '同一照片不能上传到同一集装箱。检测到重复。',
      '条件に合う写真はなかです。': '没有符合条件的照片。',
      'まだコンテナがなかです': '还没有集装箱。',
      'コンテナを選択してください': '请选择集装箱',
      コンテナ招待: '集装箱邀请',
      コンテナ招待URL: '集装箱邀请 URL',
      自分のコンテナのみ: '仅自己的集装箱',
      全コンテナ表示: '显示所有集装箱',
      全コンテナ: '所有集装箱',
      コンテナメンバー: '集装箱成员',
      'このコンテナは鍵付きです。パスワードを入力してください。': '此集装箱已上锁。请输入密码。',
      'コンテナパスワードが必要です。': '需要集装箱密码。',
      'コンテナパスワードが違います。': '集装箱密码不正确。',
      'コンテナの鍵を更新しました。': '已更新集装箱锁定。',
      'コンテナを削除しました。': '已删除集装箱。',
      'フリープランではコンテナは2つまでです。有料プランで無制限になります。':
        '免费计划最多 2 个集装箱。付费计划可无限使用。',
      '1GB〜10GBプラン: コンテナ無制限 / 3年保存 / PPT透かしなし':
        '1GB-10GB 计划：集装箱无限 / 保存 3 年 / PPT 无水印',
      'フリープラン: コンテナ2個 / 30日保存 / PPT透かしあり':
        '免费计划：2 个集装箱 / 保存 30 天 / PPT 有水印',
      '・コンテナの数が2つ以下': '- 集装箱数量不超过 2 个',
      '・現在のコンテナ数: {count}': '- 当前集装箱数：{count}',
      'コンテナ {count} / 無制限': '集装箱 {count} / 无限制',
      'コンテナ {count} / {limit}': '集装箱 {count} / {limit}',
      'フリープランへ戻すには、容量512MB未満・コンテナ2個以下である必要があります。':
        '返回免费计划需要容量低于 512MB 且集装箱不超过 2 个。',
      '現在の上限は、容量512MB未満・コンテナ2個までです。': '当前上限为容量低于 512MB、最多 2 个集装箱。',
      'コンテナ：{title} を登録しました。': '已登记集装箱：{title}。',
      'コンテナ:': '集装箱：',
      'コンテナの写真記録を、': '让集装箱照片记录',
      'もっとシンプルに。': '更简单。',
      'コンテナ番号ごとに整理。': '按集装箱编号整理。',
      '撮影から共有まで、その場で完結。': '从拍摄到共享，在现场完成。',
      '登録して無料で試す': '注册并免费试用',
      '登録なしで試す': '无需注册试用',
      'コンテナ写真の送信・仕分け・確認業務を減らします。': '减少集装箱照片的发送、分类和确认工作。',
      'コンテナ単位で管理': '按集装箱管理',
      '写真をコンテナ番号ごとに整理': '按集装箱编号整理照片',
      'タグで整理': '用标签整理',
      '搬入・シール・損傷・搬出を記録': '记录进场、封条、损伤和出场',
      'スマホで完結': '用手机完成',
      '現場で撮ってそのまま保存': '现场拍摄后直接保存',
      '現場ではこう動いている': '现场目前的流程',
      'コンテナを撮影': '拍摄集装箱',
      'LINEやメールで送信': '用 LINE 或邮件发送',
      '事務所で整理': '在办公室整理',
      'その結果': '结果',
      '送信作業が発生': '产生发送工作',
      '仕分け作業が発生': '产生分类工作',
      '写真を探す時間が発生': '产生查找照片的时间',
      '写真は残る。でも管理が大変。': '照片留下了，但管理很麻烦。',
      '撮影・送信・仕分け・確認が別々のため、': '因为拍摄、发送、分类和确认是分开的，',
      '余計な業務が発生しています。': '会产生额外工作。',
      '撮る': '拍摄',
      '送る': '发送',
      '探す': '查找',
      'この分断によって、': '这种分离导致',
      '「写真を撮った後の仕事」': '“拍照之后的工作”',
      'が発生しています。': '产生。',
      '現場は忙しい。だから複雑な仕組みは使われない。': '现场很忙，所以复杂的系统不会被使用。',
      '入力を増やせない': '不能增加输入',
      '長い入力は現場で使われない': '长输入在现场不会被使用',
      '教育できない': '难以培训',
      '誰でもすぐ使える必要がある': '任何人都需要马上能用',
      'PCを開かない': '不打开电脑',
      'スマホ中心で完結したい': '希望以手机为中心完成',
      'Congはコンテナ単位で写真を整理します。': 'Cong 按集装箱整理照片。',
      'コンテナ番号ごとに管理': '按集装箱编号管理',
      'をタグで記録': '用标签记录',
      '現場で写真を残す': '在现场留下照片',
      'タグを選ぶ': '选择标签',
      '搬入・シール・損傷・搬出': '进场、封条、损伤、出场',
      '保存': '保存',
      'コンテナごとに整理': '按集装箱整理',
      'Congが減らす3つの業務': 'Cong 减少的三项工作',
      '写真を撮る業務は変わりません。': '拍照这项工作不会改变。',
      'その後に発生する業務を減らします。': '减少拍照之后产生的工作。',
      '送信業務を減らす': '减少发送工作',
      '現場で撮った写真を': '现场拍摄的照片',
      'LINEやメールで送る手間を減らします。': '减少通过 LINE 或邮件发送的麻烦。',
      '仕分け業務を減らす': '减少分类工作',
      'コンテナ番号ごとに整理されるため、': '因为按集装箱编号整理，',
      '事務所での仕分け作業を減らします。': '减少办公室的分类工作。',
      '確認業務を減らす': '减少确认工作',
      '必要な写真が揃っているか、': '所需照片是否齐全，',
      '管理者がすぐ確認できます。': '管理员可以马上确认。',
      '写真を撮った後の仕事が変わります。': '拍照之后的工作会改变。',
      '撮る → 送る → 仕分ける': '拍摄 -> 发送 -> 分类',
      '現場は送信、': '现场负责发送，',
      '事務所は仕分け。': '办公室负责分类。',
      '写真の後処理が発生します。': '会产生照片后处理工作。',
      '撮る → 保存完了': '拍摄 -> 保存完成',
      '必要な写真がすぐ見つかります。': '需要的照片可以马上找到。',
      'コンテナ写真の管理を、': '让集装箱照片管理',
      'まずは触って、': '请先试用，',
      '今の運用との違いを体感してください。': '体验与当前运用方式的不同。',
    },
    vi: {
      'Cong | Container Log': 'Cong | Container Log',
      'Cong | Container Log デモ': 'Cong | Container Log Demo',
      'Cong - Container Log | 港湾・物流向けコンテナ写真記録サービス':
        'Cong - Container Log | Dịch vụ ghi nhận ảnh container cho cảng và logistics',
      'Cong Container Log ユーザーマニュアル': 'Cong Container Log - Hướng dẫn sử dụng',
      Cong: 'Cong',
      ...
      コンテナ登録: 'Đăng ký container',
      コンテナパスワード: 'Mật khẩu container',
      'コンテナパスワード（任意）': 'Mật khẩu container (tùy chọn)',
      'コンテナパスワード（空で解除）': 'Mật khẩu container (để trống để xóa)',
      対象コンテナ: 'Container mục tiêu',
      '現在のコンテナに設定します。空で保存すると解除されます。':
        'Thiết lập cho container hiện tại. Lưu trống để xóa.',
      'コンテナ番号を選択してください': 'Chọn số container',
      'コンテナ番号を入力してください。': 'Nhập số container.',
      記録: 'Ghi nhận',
      検索: 'Tìm kiếm',
      タグ: 'Thẻ',
      検索語: 'Từ khóa',
      このコンテナ: 'Container này',
      このお部屋: 'Phòng này',
      保存済み写真の検索: 'Tìm ảnh đã lưu',
      検索範囲: 'Phạm vi tìm kiếm',
      '保存済み写真をタグ・検索語・範囲で探します。': 'Tìm ảnh đã lưu theo thẻ, từ khóa và phạm vi.',
      'コンテナ・コメント・投稿者': 'Container, bình luận hoặc người đăng',
      ...
      新しい順: 'Mới nhất',
      古い順: 'Cũ nhất',
      '撮ってきてほしい写真を入力': 'Nhập ảnh cần chụp',
      'Congはコンテナ写真の記録・共有・管理をシンプルにするサービスです。':
        'Cong là dịch vụ giúp việc ghi nhận, chia sẻ và quản lý ảnh container trở nên đơn giản.',
      '現場で撮影した写真をコンテナ番号ごとに整理し、送信・仕分け・確認業務を減らします。':
        'Ảnh chụp tại hiện trường được sắp xếp theo số container, giảm việc gửi, phân loại và kiểm tra.',
      特徴: 'Tính năng',
      コンテナ番号単位で管理: 'Quản lý theo số container',
      タグによる分類: 'Phân loại bằng thẻ',
      写真とコメントを一元管理: 'Quản lý ảnh và bình luận tập trung',
      クエストによる撮影漏れ防止: 'Ngăn chụp thiếu bằng quest',
      PowerPoint出力: 'Xuất PowerPoint',
      権限管理: 'Quản lý quyền',
      '3. お部屋': '3. Phòng',
      'お部屋は企業・事業所単位で利用します。': 'Phòng được dùng theo từng công ty hoặc cơ sở.',
      '1ユーザー1部屋': 'Mỗi người dùng một phòng',
      URL招待: 'Mời bằng URL',
      '7日間有効': 'Có hiệu lực 7 ngày',
      '4. フォルダ': '4. Thư mục',
      'フォルダはコンテナ単位で利用します。': 'Thư mục được dùng theo từng container.',
      'コンテナ番号をフォルダ名として利用できます。': 'Có thể dùng số container làm tên thư mục.',
      例: 'Ví dụ',
      '将来的にはOCRによる自動入力にも対応予定です。': 'Dự kiến hỗ trợ nhập tự động bằng OCR trong tương lai.',
      '5. フォトフォルダ': '5. Thư mục ảnh',
      'フォトフォルダでは写真を記録します。': 'Thư mục ảnh dùng để ghi nhận ảnh.',
      '写真にはタグを付与できます。': 'Có thể gắn thẻ cho ảnh.',
      推奨タグ: 'Thẻ khuyến nghị',
      '写真ごとにコメントを残せます。': 'Có thể để lại bình luận cho từng ảnh.',
      '6. クエストフォルダ': '6. Thư mục quest',
      'クエストフォルダは撮影依頼に利用します。': 'Thư mục quest dùng cho yêu cầu chụp ảnh.',
      '□ コンテナ番号': '□ Số container',
      '□ シール': '□ Seal',
      '□ 左側面': '□ Mặt trái',
      '□ 右側面': '□ Mặt phải',
      '□ 損傷箇所': '□ Vị trí hư hỏng',
      '必要な写真を事前に依頼できます。': 'Có thể yêu cầu trước các ảnh cần chụp.',
      '撮影漏れ防止に利用します。': 'Dùng để ngăn chụp thiếu.',
      '7. 写真': '7. Ảnh',
      '写真は単体または一括アップロード可能です。': 'Có thể tải ảnh lên từng ảnh hoặc hàng loạt.',
      '撮影後にタグ付けできます。': 'Có thể gắn thẻ sau khi chụp.',
      '8. コメント': '8. Bình luận',
      シール破損あり: 'Seal bị hỏng',
      左側面にへこみあり: 'Mặt trái bị móp',
      搬出完了: 'Đã xuất bãi',
      '9. 出力': '9. Xuất',
      'フォルダ単位でPowerPoint出力できます。': 'Có thể xuất PowerPoint theo từng thư mục.',
      'コンテナ報告資料作成に利用できます。': 'Dùng để tạo tài liệu báo cáo container.',
      '10. 権限管理': '10. Quản lý quyền',
      管理者: 'Quản trị viên',
      メンバー: 'Thành viên',
      お部屋管理: 'Quản lý phòng',
      フォルダ管理: 'Quản lý thư mục',
      メンバー管理: 'Quản lý thành viên',
      写真登録: 'Đăng ký ảnh',
      コメント登録: 'Đăng ký bình luận',
      権限表: 'Bảng quyền',
      機能: 'Chức năng',
      可: 'Được phép',
      不可: 'Không được phép',
      Congレポート: 'Báo cáo Cong',
      '先にコンテナを選択してください。': 'Hãy chọn container trước.',
      '同じ写真は同じコンテナにアップロードできません（重複を検知しました）。':
        'Không thể tải cùng một ảnh lên cùng một container. Đã phát hiện trùng lặp.',
      '条件に合う写真はなかです。': 'Không có ảnh phù hợp với điều kiện.',
      'まだコンテナがなかです': 'Chưa có container.',
      'コンテナを選択してください': 'Chọn container',
      コンテナ招待: 'Lời mời container',
      コンテナ招待URL: 'URL mời container',
      自分のコンテナのみ: 'Chỉ container của tôi',
      全コンテナ表示: 'Hiển thị tất cả container',
      全コンテナ: 'Tất cả container',
      コンテナメンバー: 'Thành viên container',
      'このコンテナは鍵付きです。パスワードを入力してください。': 'Container này bị khóa. Nhập mật khẩu.',
      'コンテナパスワードが必要です。': 'Cần mật khẩu container.',
      'コンテナパスワードが違います。': 'Mật khẩu container không đúng.',
      'コンテナの鍵を更新しました。': 'Đã cập nhật khóa container.',
      'コンテナを削除しました。': 'Đã xóa container.',
      'フリープランではコンテナは2つまでです。有料プランで無制限になります。':
        'Gói miễn phí cho phép tối đa 2 container. Gói trả phí không giới hạn.',
      '1GB〜10GBプラン: コンテナ無制限 / 3年保存 / PPT透かしなし':
        'Gói 1GB-10GB: không giới hạn container / lưu 3 năm / không watermark PPT',
      'フリープラン: コンテナ2個 / 30日保存 / PPT透かしあり':
        'Gói miễn phí: 2 container / lưu 30 ngày / có watermark PPT',
      '・コンテナの数が2つ以下': '- Số container từ 2 trở xuống',
      '・現在のコンテナ数: {count}': '- Số container hiện tại: {count}',
      'コンテナ {count} / 無制限': 'Container {count} / không giới hạn',
      'コンテナ {count} / {limit}': 'Container {count} / {limit}',
      'フリープランへ戻すには、容量512MB未満・コンテナ2個以下である必要があります。':
        'Để quay lại gói miễn phí, dung lượng phải dưới 512MB và số container từ 2 trở xuống.',
      '現在の上限は、容量512MB未満・コンテナ2個までです。':
        'Giới hạn hiện tại là dưới 512MB và tối đa 2 container.',
      'コンテナ：{title} を登録しました。': 'Đã đăng ký container: {title}.',
      'コンテナ:': 'Container:',
      'コンテナの写真記録を、': 'Ghi nhận ảnh container,',
      'もっとシンプルに。': 'đơn giản hơn.',
      'コンテナ番号ごとに整理。': 'Sắp xếp theo số container.',
      '撮影から共有まで、その場で完結。': 'Từ chụp đến chia sẻ, hoàn tất ngay tại hiện trường.',
      '登録して無料で試す': 'Đăng ký và dùng thử miễn phí',
      '登録なしで試す': 'Dùng thử không cần đăng ký',
      'コンテナ写真の送信・仕分け・確認業務を減らします。':
        'Giảm việc gửi, phân loại và kiểm tra ảnh container.',
      'コンテナ単位で管理': 'Quản lý theo container',
      '写真をコンテナ番号ごとに整理': 'Sắp xếp ảnh theo số container',
      'タグで整理': 'Sắp xếp bằng thẻ',
      '搬入・シール・損傷・搬出を記録': 'Ghi nhận nhập bãi, seal, hư hỏng và xuất bãi',
      'スマホで完結': 'Hoàn tất bằng điện thoại',
      '現場で撮ってそのまま保存': 'Chụp tại hiện trường và lưu ngay',
      '現場ではこう動いている': 'Cách hiện trường đang làm',
      'コンテナを撮影': 'Chụp container',
      'LINEやメールで送信': 'Gửi qua LINE hoặc email',
      '事務所で整理': 'Sắp xếp tại văn phòng',
      'その結果': 'Kết quả',
      '送信作業が発生': 'Phát sinh việc gửi ảnh',
      '仕分け作業が発生': 'Phát sinh việc phân loại',
      '写真を探す時間が発生': 'Phát sinh thời gian tìm ảnh',
      '写真は残る。でも管理が大変。': 'Ảnh vẫn còn. Nhưng quản lý thì vất vả.',
      '撮影・送信・仕分け・確認が別々のため、': 'Vì chụp, gửi, phân loại và kiểm tra bị tách rời,',
      '余計な業務が発生しています。': 'công việc thừa phát sinh.',
      '撮る': 'Chụp',
      '送る': 'Gửi',
      '探す': 'Tìm',
      'この分断によって、': 'Sự tách rời này tạo ra',
      '「写真を撮った後の仕事」': '"việc sau khi chụp ảnh"',
      'が発生しています。': '.',
      '現場は忙しい。だから複雑な仕組みは使われない。':
        'Hiện trường rất bận. Vì vậy hệ thống phức tạp sẽ không được dùng.',
      '入力を増やせない': 'Không thể tăng thao tác nhập',
      '長い入力は現場で使われない': 'Nhập liệu dài sẽ không được dùng tại hiện trường',
      '教育できない': 'Khó đào tạo',
      '誰でもすぐ使える必要がある': 'Ai cũng cần dùng được ngay',
      'PCを開かない': 'Không cần mở PC',
      'スマホ中心で完結したい': 'Muốn hoàn tất chủ yếu bằng điện thoại',
      'Congはコンテナ単位で写真を整理します。': 'Cong sắp xếp ảnh theo từng container.',
      'コンテナ番号ごとに管理': 'Quản lý theo số container',
      'をタグで記録': 'được ghi nhận bằng thẻ',
      '現場で写真を残す': 'Lưu ảnh tại hiện trường',
      'タグを選ぶ': 'Chọn thẻ',
      '搬入・シール・損傷・搬出': 'Nhập bãi, seal, hư hỏng, xuất bãi',
      '保存': 'Lưu',
      'コンテナごとに整理': 'Sắp xếp theo container',
      'Congが減らす3つの業務': '3 công việc Cong giúp giảm',
      '写真を撮る業務は変わりません。': 'Việc chụp ảnh không thay đổi.',
      'その後に発生する業務を減らします。': 'Cong giảm các việc phát sinh sau đó.',
      '送信業務を減らす': 'Giảm việc gửi ảnh',
      '現場で撮った写真を': 'Ảnh chụp tại hiện trường',
      'LINEやメールで送る手間を減らします。': 'giảm công gửi qua LINE hoặc email.',
      '仕分け業務を減らす': 'Giảm việc phân loại',
      'コンテナ番号ごとに整理されるため、': 'Vì ảnh được sắp xếp theo số container,',
      '事務所での仕分け作業を減らします。': 'giảm việc phân loại tại văn phòng.',
      '確認業務を減らす': 'Giảm việc kiểm tra',
      '必要な写真が揃っているか、': 'Quản trị viên có thể nhanh chóng kiểm tra',
      '管理者がすぐ確認できます。': 'ảnh cần thiết đã đủ hay chưa.',
      '写真を撮った後の仕事が変わります。': 'Công việc sau khi chụp ảnh sẽ thay đổi.',
      '撮る → 送る → 仕分ける': 'Chụp -> gửi -> phân loại',
      '現場は送信、': 'Hiện trường gửi ảnh,',
      '事務所は仕分け。': 'văn phòng phân loại.',
      '写真の後処理が発生します。': 'Việc xử lý sau khi chụp phát sinh.',
      '撮る → 保存完了': 'Chụp -> lưu xong',
      '必要な写真がすぐ見つかります。': 'Ảnh cần thiết được tìm thấy nhanh chóng.',
      'コンテナ写真の管理を、': 'Quản lý ảnh container,',
      'まずは触って、': 'Hãy thử trước,',
      '今の運用との違いを体感してください。': 'và cảm nhận sự khác biệt với cách vận hành hiện tại.',
    },
  };

  for (const [language, additions] of Object.entries(CONG_TRANSLATIONS)) {
  ...
  function detectLanguage() {
    ...
    if (requested) {
      window.localStorage.setItem('kansa_language', requested);
      return requested;
    }
