    ...
    rooms: [
      {
        ...
        members: [
          ...
          { userKey: 'user-kobayashi', displayName: '小林', role: 'member', status: 'active', folderScope: 'invited', folderIds: ['folder-demo-1', 'folder-demo-4'] },
          { userKey: 'user-nakamura', displayName: '中村', role: 'member', status: 'active', folderScope: 'invited', folderIds: ['folder-demo-4'] },
        ],
        folders: [
          {
            folderId: 'folder-demo-4',
            folderCode: 'F-103',
            title: '2026年5月 撮影クエスト',
            mode: 'quest',
            ...
            photos: [
              createDemoPhoto({
                ...
                photoCode: 'P-008',
                fileName: '非常口サイン',
                viewUrl: demoSvg('非常口サイン', '#2f8f83', '#cdeef6'),
                sizeBytes: 8 * 1024 * 1024,
                questId: 'quest-demo-1',
                questText: '非常口サインが読める写真を撮ってきて',
                questCode: 'F-103-Q001',
                comments: [],
              }),
            ],
